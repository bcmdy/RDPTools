...
| 目录 | 内容 | 适用场景 |
| --- | --- | --- |
| `0.【一些教程】` | 推荐教程、PDF 教程和故障截图 | 了解远程桌面多用户、后台挂机、常见错误处理 |
...
1. 先阅读 `0.【一些教程】/0.本地远程多用户后台挂机教程.md`，这是本仓库推荐的多用户后台挂机主流程。
...
路径：`0.【一些教程】/0.本地远程多用户后台挂机教程.md`

从创建挂机用户、开启远程桌面、解除多用户限制到使用 1Remote 连接，按本仓库现有工具整理为一条优先推荐的操作路径。旧版 PDF 可作为补充资料查看。
